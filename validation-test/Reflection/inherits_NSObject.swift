...
// CHECK-64-NEXT:   (field name=a offset=16
// CHECK-64-NEXT:     (reference kind=strong refcounting=unknown))
// CHECK-64-NEXT:   (field name=_b offset=24
// CHECK-64-NEXT:     (reference kind=strong refcounting=unknown)))
...
// CHECK-32:        Type info:
// CHECK-32:        (class_instance size=24 alignment=16 stride=16 num_extra_inhabitants=0
// CHECK-32-NEXT:   (field name=a offset=16
// CHECK-32-NEXT:     (reference kind=strong refcounting=unknown))
// CHECK-32-NEXT:   (field name=_b offset=20
// CHECK-32-NEXT:     (reference kind=strong refcounting=unknown)))
