...
// RUN: %target-swift-frontend -typecheck -verify %s -I %t -target x86_64-apple-macosx10.14
...
// expected-error@-1 {{explicit '@objc' on subclass of 'ResilientNSObjectOutsideParent' requires macOS 10.15.0}}
...
extension ResilientNSObjectOutsideParent {
  ...
  // expected-error@-1 {{'@objc' instance method in extension of subclass of 'ResilientNSObjectOutsideParent' requires macOS 10.15.0}}
}
...
// expected-error@-1 {{explicit '@objc' on subclass of 'FixedLayoutNSObjectOutsideParent' requires macOS 10.15.0}}
...
extension FixedLayoutNSObjectOutsideParent {
  @objc public func categoryOneMethod() {}
  // expected-error@-1 {{'@objc' instance method in extension of subclass of 'FixedLayoutNSObjectOutsideParent' requires macOS 10.15.0}}
}
