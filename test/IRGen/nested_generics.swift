...
// CHECK-LABEL: define swiftcc void @_T015nested_generics13makeAMetadatayyF()
...
// CHECK-LABEL: define %swift.type* @_T015nested_generics18OuterGenericStructVMa(%swift.type*)

// Type constructor for OuterGenericStruct<T>.InnerGenericStruct<U>
// CHECK-LABEL: define %swift.type* @_T015nested_generics18OuterGenericStructV05InnerdE0VMa(%swift.type*, %swift.type*, %swift.type*)
...
// CHECK-LABEL: define %swift.type* @_T015nested_generics18OuterGenericStructV013InnerConcreteE0VMa(%swift.type*, %swift.type*)
...
// CHECK-LABEL: define %swift.type* @_T015nested_generics17OuterGenericClassCMa(%swift.type*)

// Type constructor for OuterGenericClass<T>.InnerGenericClass<U>
// CHECK-LABEL: define %swift.type* @_T015nested_generics17OuterGenericClassC05InnerdE0CMa(%swift.type*, %swift.type*, %swift.type*)
...
// CHECK-LABEL: define %swift.type* @_T015nested_generics17OuterGenericClassC013InnerConcreteE0CMa(%swift.type*, %swift.type*)
