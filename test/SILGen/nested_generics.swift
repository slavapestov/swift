...
// CHECK-LABEL: sil hidden @_TFVV15nested_generics5Lunch6Dinner15coolCombinationfT1twx7Topping1uwd__9Condiment_T_ : $@convention(method) <T where T : Pizza, T.Topping : CuredMeat><U where U : HotDog, U.Condiment == Deli<Pepper>.Mustard> (@in T.Topping, U.Condiment, @in_guaranteed Lunch<T>.Dinner<U>) -> ()
...
// CHECK-LABEL: sil shared @_TFFVV15nested_generics5Lunch6Dinner15coolCombinationFT1twx7Topping1uwd__9Condiment_T_L_13nestedGenericu__0_RxS_5Pizzad__S_6HotDogwxS2_S_9CuredMeatwd__S3_zOGCS_4DeliVS_6Pepper_7MustardrFT1xqd0__1yqd0_0__Tqd0__qd0_0__ : $@convention(thin) <T where T : Pizza, T.Topping : CuredMeat><U where U : HotDog, U.Condiment == Deli<Pepper>.Mustard><X, Y> (@in X, @in Y) -> (@out X, @out Y)
...
// CHECK-LABEL: sil hidden @_TFCC15nested_generics4Deli9PepperonicfT_CGCS_4Delix_9Pepperoni : $@convention(method) <Spices> (@owned Deli<Spices>.Pepperoni) -> @owned Deli<Spices>.Pepperoni
...
// CHECK-LABEL: sil hidden @_TF15nested_generics16eatDinnerGenericu0_RxS_5Pizza_S_6HotDogwx7ToppingS_9CuredMeatw_9CondimentzOGCS_4DeliVS_6Pepper_7MustardrFT1dRGVGVS_5Lunchx_6Dinnerq__1twxS2_1uw_S4__T_ : $@convention(thin) <T, U where T : Pizza, U : HotDog, T.Topping : CuredMeat, U.Condiment == Deli<Pepper>.Mustard> (@inout Lunch<T>.Dinner<U>, @in T.Topping, U.Condiment) -> ()
...
// CHECK-LABEL: sil hidden @_TF15nested_generics17eatDinnerConcreteFT1dRGVGVS_5LunchCGVS_6PizzasVS_11ChiliFlakes_7NewYork_6DinnerVCS_7HotDogs8American_1tCGCS_4DeliS2__9Pepperoni1uOGCS_4DeliVS_6Pepper_7Mustard_T_ : $@convention(thin) (@inout Lunch<Pizzas<ChiliFlakes>.NewYork>.Dinner<HotDogs.American>, @owned Deli<ChiliFlakes>.Pepperoni, Deli<Pepper>.Mustard) -> ()
...
// CHECK-LABEL: sil shared [transparent] [reabstraction_thunk] @_TTRXFo_oCGV15nested_generics6PizzasVS_11ChiliFlakes_7NewYork_iVCS_7HotDogs8American_XFo_oS2__dS4__ : $@convention(thin) (@owned Pizzas<ChiliFlakes>.NewYork, @owned @callee_owned (@owned Pizzas<ChiliFlakes>.NewYork) -> @out HotDogs.American) -> HotDogs.American
...
// CHECK-LABEL: sil hidden @_TF15nested_generics17eatDinnerConcreteFT1dRGVGVS_5LunchCGVS_6PizzasVS_6Pepper_7NewYork_6DinnerVCS_7HotDogs8American_1tCGCS_4DeliS2__9Pepperoni1uOGS7_S2__7Mustard_T_ : $@convention(thin) (@inout Lunch<Pizzas<Pepper>.NewYork>.Dinner<HotDogs.American>, @owned Deli<Pepper>.Pepperoni, Deli<Pepper>.Mustard) -> ()
...
// CHECK-LABEL: sil shared [transparent] [reabstraction_thunk] @_TTRXFo_oCGV15nested_generics6PizzasVS_6Pepper_7NewYork_iVCS_7HotDogs8American_XFo_oS2__dS4__ : $@convention(thin) (@owned Pizzas<Pepper>.NewYork, @owned @callee_owned (@owned Pizzas<Pepper>.NewYork) -> @out HotDogs.American) -> HotDogs.American

// CHECK-LABEL: // nested_generics.(calls () -> ()).(closure #1)
// CHECK-LABEL: sil shared @_TFF15nested_generics5callsFT_T_U_FCGVS_6PizzasVS_6Pepper_7NewYorkVCS_7HotDogs8American : $@convention(thin) (@owned Pizzas<Pepper>.NewYork) -> HotDogs.American
...
// CHECK-LABEL: sil shared [transparent] [reabstraction_thunk] @_TTRXFo_oCGV15nested_generics6PizzasVS_6Pepper_7NewYork_dVCS_7HotDogs8American_XFo_oS2__iS4__ : $@convention(thin) (@owned Pizzas<Pepper>.NewYork, @owned @callee_owned (@owned Pizzas<Pepper>.NewYork) -> HotDogs.American) -> @out HotDogs.American
