...
// CHECK-LABEL: sil shared [transparent] [fragile] [reabstraction_thunk] @_T0S2iIxyd_SiIxxd_S2iIyByd_SiIyByd_TR
...
// CHECK-LABEL: sil shared [transparent] [fragile] [reabstraction_thunk] @_T0SayypGIxo_So7NSArrayCSgIyBa_TR
...
// CHECK-LABEL: sil shared [transparent] [fragile] [reabstraction_thunk] @_T0SSIxo_So8NSStringCSgIyBa_TR
...
// CHECK-LABEL: sil shared [transparent] [fragile] [reabstraction_thunk] @_T0Ix_Ixx_IyB_IyBy_TR : $@convention(c) (@inout_aliasable @block_storage @callee_owned (@owned @callee_owned () -> ()) -> (), @convention(block) () -> ()) -> ()
// CHECK-LABEL: sil shared [transparent] [fragile] [reabstraction_thunk] @_T0IyB_Ix_TR : $@convention(thin) (@owned @convention(block) () -> ()) -> ()
