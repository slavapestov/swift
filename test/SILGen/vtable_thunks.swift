...
// CHECK-LABEL: sil shared [transparent] [fragile] [reabstraction_thunk] @_T013vtable_thunks1SVIxd_ACSgIxd_TR
// CHECK:         [[INNER:%.*]] = apply %0()
...
// CHECK-LABEL: sil shared [transparent] [fragile] [reabstraction_thunk] @_T013vtable_thunks1SVSgAA4NootCIxo_Ixyo_AcA3AapCSgIxo_Ixyo_TR
