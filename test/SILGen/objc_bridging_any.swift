...
class SwiftIdLover : NSObject, Anyable {
  ...
  // CHECK-LABEL: sil shared [transparent] [fragile] [reabstraction_thunk] @_T0s9AnyObject_pIyBy_ypIxi_TR
  ...
  // CHECK-LABEL: sil shared [transparent] [fragile] [reabstraction_thunk] @_T0ypIxi_s9AnyObject_pIyBy_TR : $@convention(c) (@inout_aliasable @block_storage @callee_owned (@in Any) -> (), AnyObject) -> ()
  ...
  // CHECK-LABEL: sil shared [transparent] [fragile] [reabstraction_thunk] @_T0s9AnyObject_pIyBa_ypIxr_TR : $@convention(thin) (@owned @convention(block) () -> @autoreleased AnyObject) -> @out Any
  ...
  // CHECK-LABEL: sil shared [transparent] [fragile] [reabstraction_thunk] @_T0ypIxr_s9AnyObject_pIyBa_TR : $@convention(c) (@inout_aliasable @block_storage @callee_owned () -> @out Any) -> @autoreleased AnyObject
  ...
  // CHECK-LABEL: sil shared [transparent] [fragile] [reabstraction_thunk] @_T0ypSgIxr_s9AnyObject_pSgIyBa_TR
  // CHECK: function_ref @_T0s27_bridgeAnythingToObjectiveC{{.*}}F
