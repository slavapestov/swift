...
// CHECK-LABEL: sil shared [transparent] [fragile] [thunk] @_T07dynamic3{{[_0-9a-zA-Z]*}}fcTD
...
// CHECK-LABEL: sil shared [transparent] [fragile] [thunk] @_T07dynamic3FooC0A6Method{{[_0-9a-zA-Z]*}}FTD
...
// CHECK-LABEL: sil shared [transparent] [fragile] [thunk] @_T07dynamic3FooC0A4PropSifgTD
...
// CHECK-LABEL: sil shared [transparent] [fragile] [thunk] @_T07dynamic3FooC0A4PropSifsTD
...
// CHECK-LABEL: sil shared [transparent] [fragile] [thunk] @_T07dynamic3FooC9subscriptS2iAA_tcfgTD
...
// CHECK-LABEL: sil shared [transparent] [fragile] [thunk] @_T07dynamic3FooC9subscriptS2iAA_tcfsTD
