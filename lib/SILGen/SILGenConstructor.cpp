...
void SILGenFunction::emitValueConstructor(ConstructorDecl *ctor) {
  ...
  // Emit the prolog.
  emitProlog(ctor->getParameterList(1), ArchetypeBuilder::mapTypeIntoContext(ctor, ctor->getResultInterfaceType()), ctor);
  ...
  auto &resultLowering = getTypeLowering(ArchetypeBuilder::mapTypeIntoContext(ctor, ctor->getResultInterfaceType()));
    ...
    if (!lowering.isAddressOnly()) {
      ...
      if (ctor->getFailability() != OTK_None) {
        selfValue = B.createEnum(ctor, selfValue,
                                 ...
                                 getLoweredLoadableType(ArchetypeBuilder::mapTypeIntoContext(ctor, ctor->getResultInterfaceType())));
      }
    } else {
